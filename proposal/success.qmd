...
- **Cross-ecosystem integration**: Develop interoperability with Python tools, Bayesian frameworks, and the tidymodels ecosystem to enable more flexible research workflows.
